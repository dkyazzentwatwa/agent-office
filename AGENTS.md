...
There is no package-based build system in this workspace. Open the dashboard by double-clicking `OFFICE_OPS/dashboard.html` or running:
...
## Testing Guidelines
No automated test suite is currently present. For dashboard changes, verify manually by opening `OFFICE_OPS/dashboard.html` in a browser. When changing data references in the HTML, confirm the dashboard still renders roster, coordination, and project content without console errors.
